        ...
        <div class="container">
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    ...
                    <!--                            </select>-->
                    <!--                        </li>-->
                    <li><a class="login-link"><i class="biolife-icon icon-login"></i></a><a href="dangNhap.jsp" class="login-link" >Đăng nhập/</a><a href=" dangKy.jsp" style=" background-color: white;color: orangered"> Đăng ký</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="signin-container">
                        <form action="#" name="frm-login" method="post">
                            ...
                            <p class="form-row">
                                ...
                                <input type="email" required id="fid-name" name="name" value="" class="txt-input">
                            </p>

                            <p class="form-row">
                                <label for="fid-pass">Mật khẩu:<span class="requite">*</span></label>
                                <input type="password" required id="fid-pass" name="email" value="" class="txt-input">
                            </p>
                            <p class="form-row">
                                <label for="fid-pass">Nhập lại mật khẩu:<span class="requite">*</span></label>
                                <input type="password" required  id="fid-re-pass" name="email" value="" class="txt-input">
                            </p>
