            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index-2.jsp" class="biolife-logo"><img src="assets/images/organic-3.png" alt="biolife logo" width="135" height="34"></a>
                    </div>
                    <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                        <div class="primary-menu">
                            <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                <li class="menu-item"><a href="index-2.jsp">Home</a></li>
                                        ...
                                        <div class="mega-content">
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        <li><a href="home-01.jsp">Home 01</a></li>
                                                        <li><a href="home-02.jsp">Home 02</a></li>
                                                        <li><a href="index-2.jsp">Home 03</a></li>
                                                        <li><a href="home-03-green.jsp">Home 03 Green</a></li>
                                                        <li><a href="home-04.jsp">Home 04</a></li>
                                                        <li><a href="home-04-light.jsp">Home 04 Light</a></li>
                                                        <li><a href="home-05.jsp">Home 05</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        <li class="menu-item" ><a class="menu-name" href="blog-post.jsp">Blog Single</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="blog-v01.jsp">Blog Style 01</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="blog-v02.jsp">Blog Style 02</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="blog-v03.jsp">Blog Style 03</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="contact.jsp">Contact Us</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="about-us.jsp">About Us</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="checkout.jsp">Checkout</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="shopping-cart.jsp">Shopping Cart</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="login.jsp">Login/Register</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="404.jsp">404</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        <li><a href="category-grid-3-cols.jsp">Grid 3 Cols</a></li>
                                                        <li><a href="category-grid.jsp">Grid 4 Cols</a></li>
                                                        <li><a href="category-grid-6-cols.jsp">Grid 6 Cols</a></li>
                                                        <li><a href="category-grid-left-sidebar.jsp">Grid Left Sidebar</a></li>
                                                        <li><a href="category-grid-right-sidebar.jsp">Grid Right Sidebar</a></li>
                                                        <li><a href="category-list.jsp">List Full</a></li>
                                                        <li><a href="category-list-left-sidebar.jsp">List Left Sidebar</a></li>
                                                        <li><a href="category-list-right-sidebar.jsp">List Right Sidebar</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        <li><a href="single-product-simple.jsp">Simple</a></li>
                                                        <li><a href="single-product-grouped.jsp">Grouped</a></li>
                                                        <li><a href="single-product.jsp">Variable</a></li>
                                                        <li><a href="single-product-external.jsp">External/Affiliate</a></li>
                                                        <li><a href="single-product-onsale.jsp">Countdown</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="content-404">
                        ...
                        <a class="button" href="index-2.jsp">Go to Home</a>
                    </div>
