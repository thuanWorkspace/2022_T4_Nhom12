        ...
        <div class="container">
            ...
            <div class="top-bar right">
                ...
                <ul class="horizontal-menu">
                    ...
                    <!--                            </select>-->
                    <!--                        </li>-->
                    <li><a href="thongTinTaiKhoan/thongTinTaiKhoan.jsp" class="login-link"><i class="biolife-icon icon-login"></i>xin chào <%=ua.getUser_name()%></a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="block-left">
                    <div class="block-account">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="title-info" href="./donHangCuaBan.jsp">Đơn hàng của bạn</a>
                            </li>
                            <li>
                    ...
                    <div class="account-modal" id="js-account-modal">
                        <div class="account-modal-container">
                            ...
                            <div class="account-modal-body">
                                <form action="">
                                    <input class="account-modal-input" placeholder="Họ tên" type="text" name="">
                                    <input class="account-modal-input" placeholder="Số điện thoại" type="number" id="Phone" pattern="\d+" name="Phone" maxlength="12" value="">
                                    <input class="account-modal-input" placeholder="Tỉnh/thành phố" type="text" name="">
                                    <input type="text" list="Country" placeholder="Quận/huyện" class="account-modal-input">
                                    <input class="account-modal-input" type="text" placeholder="Phường/xã" name="Zip" id="">
                                    <input class="account-modal-input" placeholder="Địa chỉ nhận hàng" type="text" name="">
                                    <datalist id="Country">
