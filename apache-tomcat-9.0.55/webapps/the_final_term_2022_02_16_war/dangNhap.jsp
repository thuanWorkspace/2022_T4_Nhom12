            ...
            <div class="container">
                ...
                <div class="top-bar right">
                    ...
                    <ul class="horizontal-menu">
                        ...
                        <!--                            </select>-->
                        <!--                        </li>-->
                        <li><a class="login-link"><i class="biolife-icon icon-login"></i></a><a href="dangNhap.jsp" class="login-link" style=" background-color: white;color: orangered">Đăng nhập/</a><a href=" dangKy.jsp"> Đăng ký</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="signin-container">
                            <form action="DangNhap" name="frm-login" method="post">
                                ...
                                <p class="form-row wrap-btn">
                                    ...
                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/the_final_term_2022_02_16_war/LoginGoogleHandler&response_type=code
