                    ...
                    <div class="signin-container">
                        <form action="#" name="frm-login" method="post">
                            <p class="form-row">
                                ...
                                <input type="email" id="fid-name" name="name" value="" class="txt-input" placeholder="nhập email để khôi phục tài khoản">
                            </p>

                            <p class="form-row wrap-btn">
                                <button class="btn btn-submit btn-bold" type="submit">khôi phục</button>
                                <a href="#" class="link-to-help">tôi chưa nhận được email?</a>
